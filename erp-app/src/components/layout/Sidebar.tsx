...
import { getNotificaciones } from "@/modules/notificaciones/queries";
...
export async function Sidebar() {
  ...
  const [codigos, { data: usuario }, notificaciones] = await Promise.all([
    getUserSubmodulos(),
  ...
  return (
    <>
      ...
      <MobileNav modulosVisibles={modulosVisibles} nombre={nombre} notificaciones={notificaciones} />
    </>
  );
}
