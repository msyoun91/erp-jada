...
Estado: **1, 2 y 4 hechos**; **3 descartado** (su premisa era falsa — ver ahí).
Pendientes: 5, 6, 7 y 8.
...
tanda anterior. Lo siguiente en la fila es el punto 5 (N+1 en Plantillas). Queda además
