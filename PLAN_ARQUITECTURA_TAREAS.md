...
Estado: **1, 2, 4, 5 y 6 hechos**; **3 descartado** (su premisa era falsa — ver ahí).
Pendientes: 7 y 8.
...
tanda anterior. Lo siguiente en la fila es el punto 7 (`ESTADO_LABEL` / `ESTADO_BADGE` sin tipar). Queda además
